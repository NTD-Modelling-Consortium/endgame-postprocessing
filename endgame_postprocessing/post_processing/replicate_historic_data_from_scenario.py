...
def replicate_historic_data_in_all_scenarios(results: CanonicalResults, source_scenario: str) -> CanonicalResults: # noqa E501
    ...
    for scenario in results:
        ...
        for iu in ius_without_historic_data:
            warnings.warn(f"IU {iu} was not found in {source_scenario} and as such will not have the historic data") # noqa E501
            ius_to_exclude.append(iu)
